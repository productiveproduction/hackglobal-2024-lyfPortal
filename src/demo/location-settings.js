...
export const getLocationSettingsSection = async (locationConfig) => {
  ...
  autocomplete.addListener("place_changed", () => {
    ...
    document.querySelector('.demo-canvas')?.remove()
    ...
    setCustomConfig("location.coordinates.lat", locationHiddenInputLat.value);
    setCustomConfig("location.coordinates.lng", locationHiddenInputLng.value);
