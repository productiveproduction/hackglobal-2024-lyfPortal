// Original: https://github.com/suren-atoyan/react-pwa/blob/master/src/utils/loader/loader.tsx
...
function getDelayedFallback(Fallback, delay) {
...
function asyncComponentLoader(loadComponent, additionalProps, loaderOptions, FallbackWaiting) {
