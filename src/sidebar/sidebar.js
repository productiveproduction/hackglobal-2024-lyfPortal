...
import { getPlaceDetails } from "../util/places.js";
import { setSelectedMarker } from "../util/create-markers.js";

// const baseSidebar = document.getElementById("sidebar").cloneNode(true); // empty sidebar state for resetting purposes
const baseSidebar = document.getElementById("sidebar"); // empty sidebar state for resetting purposes
